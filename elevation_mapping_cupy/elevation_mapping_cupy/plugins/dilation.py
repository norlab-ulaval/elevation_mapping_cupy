...
class Dilation(PluginBase):
    ...
    Dilation is a morphological operation that is used to expand or grow the boundaries of objects
    in a binary image or to fill in small holes and gaps.
    ...
    def __call__(
        ...
        *args,
        ...
        if layer_max - layer_min == 0:
            # If all values are the same, return the original layer as dilation won't change anything
            return layer_data
